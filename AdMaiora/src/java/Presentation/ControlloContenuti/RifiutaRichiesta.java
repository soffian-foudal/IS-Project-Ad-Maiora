...
/**
 *  Servlet per il rifiuto di una richiesta di creazione, il metodo di 
...
public class RifiutaRichiesta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet RifiutaRichiesta</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet RifiutaRichiesta at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
     ...
     * al rifiuto di una richiesta di creazione, relativa ad una
     * discussione.
     *
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(id != -1) {
            ...
            if(null != richiesta)
                managerRichiesta.rifiutaRichiesta(richiesta);
        }
