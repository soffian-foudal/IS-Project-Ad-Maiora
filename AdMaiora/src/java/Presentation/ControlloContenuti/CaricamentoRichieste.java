...
/**
 *  Servlet per la lettura delle richieste di creazione, il metodo di 
 ...
 */
public class CaricamentoRichieste extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CaricamentoRichieste</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CaricamentoRichieste at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
     ...
     * alla lettura delle richieste di creazione.
     *
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<RichiestaCreazione> richieste = managerRichiesta.getAll();
